...
- `baseline`: `token drift`, score 149, lane `ship`
- `stress`: `grammar width`, score 151, lane `ship`
- `edge`: `label quality`, score 149, lane `ship`
- `recovery`: `error locality`, score 172, lane `ship`
