"""Regression checks for the notion-parse-dsl-stack casebook."""
...
from casebook.harness import assert_expected, notion_parse_dsl_stack_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(notion_parse_dsl_stack_summary(), assert_expected())
